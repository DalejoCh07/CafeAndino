...
public class CafeAndino {
    ...
    public static void main(String[] args) {
        ...
        ItemPedido itemUno=new ItemPedido(1, "Capuchino", Tallas.GRANDE);
        itemUno.agregarExtra("Avena");
        itemUno.eliminarExtra("Leche entera");
        itemUno.cambiarTalla(Tallas.MEDIANO);
    }
}
